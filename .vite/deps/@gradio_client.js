...
var at = "sleeptime";
var ct = "heartbeat";
var lt = "component_server";
var ut = "reset";
var pt = "cancel";
var ft = "app_id";
var ht = "https://gradio-space-api-fetcher-v2.hf.space/api";
var je = "This application is currently busy. Please try again. ";
var M = "Connection errored out. ";
var z = "Could not resolve app config. ";
var dt = "Could not get space status. ";
var _t = "Could not get API info. ";
var _e = "Space metadata could not be loaded. ";
var mt = "Invalid URL. A full URL path is required.";
var gt = "Not authorized to access this space. ";
var xe = "Invalid credentials. Could not login. ";
var wt = "Login credentials are required to access this space.";
var yt = "File system access is only available in Node.js environments";
